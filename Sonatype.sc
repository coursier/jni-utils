// Remove this file once https://github.com/com-lihaoyi/mill/pull/1245 is merged
// and we bump the mill version.
...
class CustomSonatypePublisher(uri: String,
                        snapshotUri: String,
                        credentials: String,
                        signed: Boolean,
                        gpgArgs: Seq[String],
  ...
  private def gpgSigned(file: os.Path, args: Seq[String]): os.Path = {
    ...
    println(s"Running ${command.toString.replace(sys.env("PGP_PASSWORD"), "****")}")
